...
// IMAGE IMPORTS
import greeceImage1 from '../../../assets/images/greece/20240713_150455241_iOS_1_11zon.webp';
import greeceImage2 from '../../../assets/images/greece/20240713_155959406_iOS_2_11zon.webp';
import greeceImage3 from '../../../assets/images/greece/20240713_161059912_iOS_3_11zon.webp';
...
import greeceImage6 from '../../../assets/images/greece/20240713_162235775_iOS_6_11zon.webp';
...
import greeceImage20 from '../../../assets/images/greece/20240719_152101890_iOS_20_11zon.webp';
...
const Travel = () => {
  const greeceImages = [greeceImage1, greeceImage2, greeceImage3, greeceImage4, greeceImage5, 
    ...
    greeceImage18, greeceImage19, greeceImage20];

  return (
    <section id="subSectionTravel" className="">
      <h1 className="text-2xl font-bold pb-2">Travel</h1>
      <p className="p-tag-default">The time I spent in Greece occupies a special place in my heart. I spent 5 days in both Athens, and the island of Milos among the Cyclades.</p>
      ...
      <p className="p-tag-default">California kush roll it up into a fat blunt for medicinal purposes to elevate your
           consciousness. Legalize spliffs for recreational Snoop Dogg edibles pusher cannabidiol cartoons. Just give
            ...
            ganja shaman.</p>
      <p className="p-tag-default">Wake and bake indica hash at the dispensary in Oregon decriminalized. Dude you’re
      ...
      <p className="p-tag-default">Have you ever tried Lorem Ipsum on Weeeeeeeeeeed? OG grandaddy purps with notes
