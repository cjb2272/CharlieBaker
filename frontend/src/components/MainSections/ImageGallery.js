  ...
  return (
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-4">
        {/* Main large image */}
        <div 
          className="lg:row-span-2 lg:col-span-2 relative overflow-hidden cursor-pointer h-96 lg:h-auto" 
        ...
        {images.slice(1, 3).map((image, index) => (
          <div
            key={index}
            className="relative overflow-hidden cursor-pointer h-64 lg:h-auto"
